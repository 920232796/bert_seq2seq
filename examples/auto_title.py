...
class Trainer:
    def __init__(self):
        ...
        # validset = BertDataset(self.valid_src,self.valid_tgt,self.vocab_path)
        # self.validloader = DataLoader(validset,batch_size=self.batch_size,shuffle=True,collate_fn = collate_fn)
    ...
    def eval(self,epoch):
        ...
        self.iteration(epoch,dataloader=self.validloader,train=False)
