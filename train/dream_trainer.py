...
import os
import json
from config import sentiment_batch_size, sentiment_lr, dream_train_corpus_path, bert_chinese_model_path
...
class DreamDataset(Dataset):
    ...
    def __init__(self) :
        ...
        # 读原始数据
        self.sents_src, self.sents_tgt = read_corpus(dream_train_corpus_path)
...
class DreamTrainer:
    ...
    def save_state_dict(self, model, epoch, file_path="bert_dream.model"):
        """存储当前模型参数"""
